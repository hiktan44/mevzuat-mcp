...
- Resmî veri sandbox üzerinden çekildi: mevzuat.gov.tr ara sertifika (GeoTrust) göndermediği için `trusted_certificates` ile doğrulama; gözetim metinlerinin 149/194'ü tohumda, kalanı günlük eşitlemede tamamlanır (site 150 istek sonrası yavaşlıyor; eşitleme istekler arasında bekler).
