...
- Resmî veri sandbox üzerinden çekildi: mevzuat.gov.tr ara sertifika (GeoTrust) göndermediği için `trusted_certificates` ile doğrulama; gözetim metinlerinin 193/194'ü tohumda (1.167 satır; 16 metinde tablo biçimi farklı, satır çıkmadı) (site 150 istek sonrası yavaşlıyor; eşitleme istekler arasında bekler).
