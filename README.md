...
* **Tarım ürünleri tarife kontenjanları**: Bakanlığın ülke bazlı "... Menşeli Bazı Tarım Ürünleri İthalatında Tarife Kontenjanı Uygulanması Hakkında Karar" eklerinden (.docx/.doc) GTİP, kontenjan miktarı, dönem ve kontenjan dâhili vergi oranı; menşe ülke (AB, EFTA ve Birleşik Krallık grup adları dâhil) ile eşlenir. Eski `.doc` ekleri sunucuda `antiword` ile okunur.
